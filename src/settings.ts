...
export class LiveListSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Log key plugin events to the developer console (Ctrl+Shift+I / Cmd+Option+I). " +
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Log every skipped editor event with its reason. Useful when the plugin " +
          "appears to do nothing. Errors are always logged regardless of this setting."
      )
      .addToggle((toggle) =>
